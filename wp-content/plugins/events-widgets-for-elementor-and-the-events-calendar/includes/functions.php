...
function ectbe_event_schedule( $event_id, $date_format, $template ) {
	...
	if ( $date_format == 'DM' ) {
		  $event_schedule = '<div class="ectbe-date-area ' . esc_attr( $template ) . '-schedule"  itemprop="startDate" content="' . esc_attr( tribe_get_start_date( $event_id, false, 'Y-m-dTg:i' ) ) . '">
                                <span class="ev-day">' . esc_attr( tribe_get_start_date( $event_id, false, 'd' ) ) . '</span>
                                <span class="ev-mo">' . esc_attr( tribe_get_start_date( $event_id, false, 'M' ) ) . '</span>
                                </div>
                                <meta itemprop="endDate" content="' . esc_attr( tribe_get_end_date( $event_id, false, 'Y-m-dTg:i' ) ) . '">';
		...
		$event_schedule = '<div class="ectbe-date-area ' . esc_attr( esc_attr( $template ) ) . '-schedule"  itemprop="startDate" content="' . esc_attr( tribe_get_start_date( $event_id, false, 'Y-m-dTg:i' ) ) . '">
                                <span class="ev-mo">' . esc_html( tribe_get_start_date( $event_id, false, 'M' ) ) . '</span>
                                <span class="ev-day">' . esc_html( tribe_get_start_date( $event_id, false, 'd' ) ) . ', </span>
                                <span class="ev-yr">' . esc_html( tribe_get_start_date( $event_id, false, 'Y' ) ) . '</span>
                                </div>
		...
		$event_schedule = '<div class="ectbe-date-area ' . esc_attr( $template ) . '-schedule" itemprop="startDate" content="' . esc_attr( tribe_get_start_date( $event_id, false, 'Y-m-dTg:i' ) ) . '">
                                ...
                                <span class="ev-mo">' . esc_html( tribe_get_start_date( $event_id, false, 'F' ) ) . '</span>
                                <span class="ev-yr">' . esc_html( tribe_get_start_date( $event_id, false, 'Y' ) ) . '</span>
                                <span class="ev-time"><span class="ectbe-icon"><i class="ectbe-icon-clock" aria-hidden="true"></i></span> ' . esc_html( $ev_time ) . '</span>
                                </div>
                                <meta itemprop="endDate" content="' . esc_attr( tribe_get_end_date( $event_id, false, 'Y-m-dTg:i' ) ) . '">';
