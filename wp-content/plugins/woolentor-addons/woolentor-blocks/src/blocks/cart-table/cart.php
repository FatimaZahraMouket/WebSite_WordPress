						...
						<?php
							foreach ( $cartitem as $itemvalue ) {
								...
								if( !empty( $itemvalue['width'] ) ){
									$cell_row_width = "width:{$itemvalue['width']}px";
								}

								switch ( $itemvalue['fieldkey'] ) {

									case 'remove':
										echo '<td class="product-remove" style="'.$cell_row_width.'">';
									...
									case 'thumbnail':
										echo '<td class="product-thumbnail" style="'.$cell_row_width.'">';
									...
									case 'name':
										echo '<td class="product-name" data-title="'.$itemvalue['heading'].'" style="'.$cell_row_width.'">';
									...
									case 'price':
										echo '<td class="product-price" data-title="'.$itemvalue['heading'].'" style="'.$cell_row_width.'">';
											echo apply_filters( 'woocommerce_cart_item_price', WC()->cart->get_product_price( $_product ), $cart_item, $cart_item_key );
										echo '</td>';
										break;

									case 'quantity':
										echo '<td class="product-quantity" data-title="'.$itemvalue['heading'].'" style="'.$cell_row_width.'">';
									...
									case 'subtotal':
										echo '<td class="product-subtotal" data-title="'.$itemvalue['heading'].'" style="'.$cell_row_width.'">';
											echo apply_filters( 'woocommerce_cart_item_subtotal', WC()->cart->get_product_subtotal( $_product, $cart_item['quantity'] ), $cart_item, $cart_item_key );
										echo '</td>';
										break;

									case 'customadd':
										echo '<td class="product-wlcustomdata" style="'.$cell_row_width.'">';
